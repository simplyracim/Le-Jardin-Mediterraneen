...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { id: 'mezze', name: 'Mediterranean Mezze Platter', description: 'Hummus, baba ganoush, falafel, marinated olives & warm pita.', price: 3600, tags: ['V'], image: 'https://loremflickr.com/600/400/mezze,food?lock=1000' },
      ...
      { id: 'harira', name: 'Harira Soup', description: 'Traditional Algerian tomato-based soup with lentils, chickpeas & fresh herbs.', price: 1800, image: 'https://loremflickr.com/600/400/soup,food?lock=1003' },
      ...
      { id: 'merguez', name: 'Spicy Merguez Sausages', description: 'Grilled Algerian lamb sausages with harissa & grilled bread.', price: 2550, image: 'https://loremflickr.com/600/400/sausage,food?lock=1005' },
  ...
  },
  {
    ...
    items: [
      { id: 'harira-soup', name: 'Harira Soup', description: 'Traditional Moroccan-Algerian soup with tomatoes, lentils, chickpeas & fragrant spices.', price: 1800, image: 'https://loremflickr.com/600/400/salad,food?lock=1008' },
      ...
      { id: 'beet-salad', name: 'Roasted Beet & Goat Cheese Salad', description: 'Roasted beets, creamy goat cheese, walnuts & balsamic glaze.', price: 2550, tags: ['V', 'GF'], image: 'https://loremflickr.com/600/400/salad,food?lock=1012' },
      { id: 'tabbouleh', name: 'Tabbouleh', description: 'Fresh parsley, bulgur, tomato, mint, lemon juice & olive oil.', price: 2100, tags: ['V'], image: 'https://loremflickr.com/600/400/salad,food?lock=1013' },
    ],
  },
  {
    id: 'pasta',
    ...
    items: [
      { id: 'seafood-linguine', name: 'Seafood Linguine', description: 'Linguine pasta with shrimp, mussels, calamari & cherry tomatoes in garlic white wine sauce.', price: 4200, image: 'https://loremflickr.com/600/400/pasta,food?lock=1014' },
  ...
  },
  {
    ...
    items: [
      { id: 'margherita', name: 'Margherita Pizza', description: 'Tomato sauce, fresh mozzarella, basil & olive oil.', price: 2700, tags: ['V'], image: 'https://loremflickr.com/600/400/pizza?lock=1018' },
      { id: 'med-pizza', name: 'Mediterranean Pizza', description: 'Hummus base, roasted vegetables, feta cheese, olives & oregano.', price: 3300, tags: ['V'], image: 'https://loremflickr.com/600/400/pizza?lock=1019' },
      { id: 'merguez-pizza', name: 'Lamb Merguez Pizza', description: 'Spiced lamb sausage, roasted peppers, caramelized onions & harissa drizzle.', price: 3600, image: 'https://loremflickr.com/600/400/pizza?lock=1020' },
      { id: 'seafood-pizza', name: 'Seafood Pizza', description: 'Garlic cream base, shrimp, calamari, mussels, capers & fresh parsley.', price: 3900, image: 'https://loremflickr.com/600/400/pizza?lock=1021' },
    ],
  },
  {
    id: 'couscous',
    ...
    items: [
      { id: 'lamb-couscous', name: 'Lamb Couscous', description: 'Steamed semolina with tender lamb, chickpeas, carrots, zucchini & aromatic broth.', price: 4200, image: 'https://loremflickr.com/600/400/couscous,food?lock=1022' },
      { id: 'chicken-couscous', name: 'Chicken Couscous', description: 'Steamed semolina with roasted chicken, turnips, cabbage & raisins.', price: 3900, image: 'https://loremflickr.com/600/400/couscous,food?lock=1023' },
      ...
      { id: 'royal-couscous', name: 'Royal Couscous', description: 'Steamed semolina with lamb, chicken, merguez & mixed vegetables.', price: 4800, image: 'https://loremflickr.com/600/400/couscous,food?lock=1025' },
    ],
  },
  {
    id: 'tagines',
  ...
  },
  {
    ...
    items: [
      { id: 'sangria', name: 'Mediterranean Sangria', description: 'Red wine, orange liqueur, fresh fruits & a touch of cinnamon.', price: 2100, image: 'https://loremflickr.com/600/400/drink,beverage?lock=1036' },
      { id: 'mint-mojito', name: 'Algerian Mint Mojito', description: 'White rum, fresh mint, lime, sugar & soda water.', price: 1950, image: 'https://loremflickr.com/600/400/drink,beverage?lock=1037' },
      ...
      { id: 'red-wine', name: 'House Red Wine (Glass)', description: 'A selection of Mediterranean reds.', price: 1800, image: 'https://loremflickr.com/600/400/drink,beverage?lock=1040' },
      { id: 'white-wine', name: 'House White Wine (Glass)', description: 'Crisp, refreshing whites from the region.', price: 1800, image: 'https://loremflickr.com/600/400/drink,beverage?lock=1041' },
